...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Enterprises',
            fields=[
                ('enterprise_id', models.CharField(max_length=20, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enterprise', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AuthenticationApp.enterprises')),
